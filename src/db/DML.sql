...
(SELECT CAST('00000000-0000-0000-0000-000000000002' AS UUID), 
 ...
 'Destination Void', 
 'The starship Earthling, filled with thousands of hybernating colonists en route to a new world at Tau Ceti, is stranded beyond the solar system.',
...
(SELECT CAST('00000000-0000-0000-0000-000000000003' AS UUID), 
 ...
 'The bestselling author decodes the behavior of people around you, distilling ancient wisdom and philosophy for seekers of power, influence and mastery.',
...
(SELECT CAST('00000000-0000-0000-0000-000000000006' AS UUID), 
 ...
 (SELECT CAST('00000000-0000-0000-0000-000000000007' AS UUID),
  ...
  'A Time for Mercy',
  'The hero of A Time to Kill, one of the most popular novels of our time,  returns in a courtroom drama that showcases bestselling author at the height of his storytelling powers.',
  ...
  (SELECT CAST('00000000-0000-0000-0000-000000000008' AS UUID),
   ...
   'Nashville Legends second baseman Gavin Scott''s marriage is in major trouble. He discovered a humiliating secret: his wife has always faked the Big O.',
